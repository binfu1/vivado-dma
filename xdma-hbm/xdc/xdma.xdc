...
set_property PACKAGE_PIN AR15 [get_ports {sys_clk_clk_p}]
set_property PACKAGE_PIN AR14 [get_ports {sys_clk_clk_n}]

create_clock -period 10.000	 [get_ports hbm_refclk]
set_clock_groups -asynchronous -group [get_clocks hbm_refclk -include_generated_clocks]
set_property PACKAGE_PIN G18     [get_ports hbm_refclk]
set_property IOSTANDARD LVCMOS18 [get_ports hbm_refclk]
