...
proc create_root_design { parentCell } {
  ...
  set ddr4_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 ddr4_1 ]

  set ddr4_2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 ddr4_2 ]

  set ddr4_clk_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_clk_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {300000000} \
   ] $ddr4_clk_0

  set ddr4_clk_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_clk_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {300000000} \
   ] $ddr4_clk_1

  set ddr4_clk_2 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_clk_2 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {300000000} \
   ] $ddr4_clk_2
  ...
  connect_bd_intf_net -intf_net C0_SYS_CLK_0_1 [get_bd_intf_ports ddr4_clk_1] [get_bd_intf_pins ddr4_1/C0_SYS_CLK]
  connect_bd_intf_net -intf_net C0_SYS_CLK_0_2 [get_bd_intf_ports ddr4_clk_2] [get_bd_intf_pins ddr4_2/C0_SYS_CLK]
  connect_bd_intf_net -intf_net axi_interconnect_ddr_axi_M00_AXI [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI] [get_bd_intf_pins interconnect_axi/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ddr_axil_M01_AXI [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI_CTRL] [get_bd_intf_pins interconnect_axil/M00_AXI]
  connect_bd_intf_net -intf_net ddr4_1_C0_DDR4 [get_bd_intf_ports ddr4_1] [get_bd_intf_pins ddr4_1/C0_DDR4]
  connect_bd_intf_net -intf_net ddr4_2_C0_DDR4 [get_bd_intf_ports ddr4_2] [get_bd_intf_pins ddr4_2/C0_DDR4]
  connect_bd_intf_net -intf_net ddr4_C0_DDR4 [get_bd_intf_ports ddr4_0] [get_bd_intf_pins ddr4_0/C0_DDR4]
  connect_bd_intf_net -intf_net ddr4_clk_1 [get_bd_intf_ports ddr4_clk_0] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
  connect_bd_intf_net -intf_net interconnect_axi_M01_AXI [get_bd_intf_pins ddr4_1/C0_DDR4_S_AXI] [get_bd_intf_pins interconnect_axi/M01_AXI]
  connect_bd_intf_net -intf_net interconnect_axi_M02_AXI [get_bd_intf_pins ddr4_2/C0_DDR4_S_AXI] [get_bd_intf_pins interconnect_axi/M02_AXI]
  connect_bd_intf_net -intf_net interconnect_axil_M01_AXI [get_bd_intf_pins ddr4_1/C0_DDR4_S_AXI_CTRL] [get_bd_intf_pins interconnect_axil/M01_AXI]
  connect_bd_intf_net -intf_net interconnect_axil_M02_AXI [get_bd_intf_pins ddr4_2/C0_DDR4_S_AXI_CTRL] [get_bd_intf_pins interconnect_axil/M02_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_ddr_M_AXI_LITE] [get_bd_intf_pins ila_ddr_axil/SLOT_0_AXI] [get_bd_intf_pins xdma/M_AXI_LITE]
  ...
  connect_bd_net -net ddr4_1_c0_ddr4_ui_clk [get_bd_pins ddr4_1/c0_ddr4_ui_clk] [get_bd_pins interconnect_axi/M01_ACLK] [get_bd_pins interconnect_axil/M01_ACLK]
  connect_bd_net -net ddr4_1_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_1/c0_ddr4_ui_clk_sync_rst] [get_bd_pins logic_not_uirst_1/Op1]
  connect_bd_net -net ddr4_2_c0_ddr4_ui_clk [get_bd_pins ddr4_2/c0_ddr4_ui_clk] [get_bd_pins interconnect_axi/M02_ACLK] [get_bd_pins interconnect_axil/M02_ACLK]
  connect_bd_net -net ddr4_2_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_2/c0_ddr4_ui_clk_sync_rst] [get_bd_pins logic_not_uirst_2/Op1]
  connect_bd_net -net ddr4_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins interconnect_axi/M00_ACLK] [get_bd_pins interconnect_axil/M00_ACLK]
  connect_bd_net -net ddr4_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins logic_not_uirst_0/Op1]
  connect_bd_net -net logic_not_Res [get_bd_pins ddr4_0/sys_rst] [get_bd_pins ddr4_1/sys_rst] [get_bd_pins ddr4_2/sys_rst] [get_bd_pins logic_not_sysrst/Res]
  connect_bd_net -net logic_not_uirst_1_Res [get_bd_pins ddr4_1/c0_ddr4_aresetn] [get_bd_pins interconnect_axi/M01_ARESETN] [get_bd_pins interconnect_axil/M01_ARESETN] [get_bd_pins logic_not_uirst_1/Res]
  connect_bd_net -net logic_not_uirst_2_Res [get_bd_pins ddr4_2/c0_ddr4_aresetn] [get_bd_pins interconnect_axi/M02_ARESETN] [get_bd_pins interconnect_axil/M02_ARESETN] [get_bd_pins logic_not_uirst_2/Res]
  connect_bd_net -net logic_not_uirst_Res [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins interconnect_axi/M00_ARESETN] [get_bd_pins interconnect_axil/M00_ARESETN] [get_bd_pins logic_not_uirst_0/Res]
  connect_bd_net -net sys_rstn_1 [get_bd_ports sys_rstn] [get_bd_pins logic_not_sysrst/Op1] [get_bd_pins xdma/sys_rst_n]
  connect_bd_net -net xdma_ddr_axi_aclk [get_bd_pins ila_ddr_axi/clk] [get_bd_pins ila_ddr_axil/clk] [get_bd_pins interconnect_axi/ACLK] [get_bd_pins interconnect_axi/S00_ACLK] [get_bd_pins interconnect_axil/ACLK] [get_bd_pins interconnect_axil/S00_ACLK] [get_bd_pins xdma/axi_aclk]
