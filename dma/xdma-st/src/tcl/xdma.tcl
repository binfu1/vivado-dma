...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_2_BRAM_PORTA [get_bd_intf_pins bram_axil/BRAM_PORTA] [get_bd_intf_pins bram_ctrl_axil/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins bram_ctrl_axil/S_AXI] [get_bd_intf_pins xdma/M_AXI_LITE]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M00_AXI] [get_bd_intf_pins ila_axil/SLOT_0_AXI] [get_bd_intf_pins xdma/M_AXI_LITE]
  connect_bd_intf_net -intf_net xdma_M_AXIS_H2C_0 [get_bd_intf_pins xdma/M_AXIS_H2C_0] [get_bd_intf_pins xdma/S_AXIS_C2H_0]
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_M_AXIS_H2C_0] [get_bd_intf_pins system_ila/SLOT_0_AXIS] [get_bd_intf_pins xdma/M_AXIS_H2C_0]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins bram_ctrl_axil/s_axi_aresetn] [get_bd_pins system_ila/resetn] [get_bd_pins xdma/axi_aresetn]
  connect_bd_net -net sys_rstn_1 [get_bd_ports sys_rstn] [get_bd_pins xdma/sys_rst_n]
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins bram_ctrl_axil/s_axi_aclk] [get_bd_pins ila_axil/clk] [get_bd_pins system_ila/clk] [get_bd_pins xdma/axi_aclk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces xdma/M_AXI_LITE] [get_bd_addr_segs bram_ctrl_axil/S_AXI/Mem0] -force
